    ...
    def save(entity):
        try:
            ...
            if len(i) == 0:
                ...
                c.execute('upRoomNumber Room set meal=' +str(entity.meal)+', Hotelid='+ str(entity.hotelId)+', Type='+ str(entity.type)+', available='+ str(entity.available)+', cost_per_night='+ str(entity.cost)+', num_of_bedrooms='+ str(entity.bedroom)+', _number='+ str(entity.number)+' where code='+ str(entity.id))
